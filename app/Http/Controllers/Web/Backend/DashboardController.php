...
//            }
	...
	public function confirmWithdraw(\Illuminate\Http\Request $request, \VanguardLTE\Withdraw $withdraw, $status)
        {
            if ($withdraw) {
                $withdraw->update(['status' => $status]);
            }

            return redirect()->back()->withSuccess('Withdraw Confirmed!');
        }
    }
