<?php 
namespace VanguardLTE\Games\GreatRhino2
{
    set_time_limit(5);
    class Server
    {
            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('GreatRhino2BonusWin', 0);
                        $slotSettings->SetGameData('GreatRhino2FreeGames', 0);
                        $slotSettings->SetGameData('GreatRhino2CurrentFreeGame', 0);
                        $slotSettings->SetGameData('GreatRhino2TotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('GreatRhino2BonusState', 0);
                        $slotSettings->SetGameData('GreatRhino2BonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('GreatRhino2DealerCard');
                        $totalWin = $slotSettings->GetGameData('GreatRhino2TotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('GreatRhino2TotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('GreatRhino2DealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') <= $slotSettings->GetGameData('GreatRhino2FreeGames') && $slotSettings->GetGameData('GreatRhino2FreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('GreatRhino2CurrentFreeGame', $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('GreatRhino2BonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('GreatRhino2FreeGames') == 0 ) 
                            {
                                $slotSettings->SetGameData('GreatRhino2BonusMpl', 1);
                                $slotSettings->SetGameData('GreatRhino2FreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('GreatRhino2CurrentFreeGame', 1);
                                $spinType = 's&fsmul=' . $slotSettings->GetGameData('GreatRhino2BonusMpl') . '&fsmax=' . $slotSettings->GetGameData('GreatRhino2FreeGames') . '&fswin=' . $totalWin . '&fs=1&fsres=' . $totalWin;
                            }
                            else
                            {
                                $slotSettings->SetGameData('GreatRhino2FreeGames', $slotSettings->GetGameData('GreatRhino2FreeGames') + $slotSettings->slotFreeCount);
                            }
                        }
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('GreatRhino2BonusWin', $slotSettings->GetGameData('GreatRhino2BonusWin') + $totalWin);
                            $slotSettings->SetGameData('GreatRhino2TotalWin', $slotSettings->GetGameData('GreatRhino2TotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('GreatRhino2FreeBalance');
                            if( $slotSettings->GetGameData('GreatRhino2FreeGames') + 1 <= $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') && $slotSettings->GetGameData('GreatRhino2FreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('GreatRhino2FreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('GreatRhino2BonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('GreatRhino2BonusWin') . '&fsres_total=' . $slotSettings->GetGameData('GreatRhino2BonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('GreatRhino2BonusMpl') . '&fsmax=' . $slotSettings->GetGameData('GreatRhino2FreeGames') . '&fswin=' . $slotSettings->GetGameData('GreatRhino2TotalWin') . '&fs=' . $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('GreatRhino2BonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('GreatRhino2TotalWin', $totalWin);
                            $slotSettings->SetGameData('GreatRhino2BonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('GreatRhino2BonusWin') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&n_reel_set=0&counter=' . ((int)$postData['counter'] + 1) . '&l=20&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('GreatRhino2FreeGames') + 1 <= $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') && $slotSettings->GetGameData('GreatRhino2FreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('GreatRhino2TotalWin', 0);
                            $slotSettings->SetGameData('GreatRhino2BonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('GreatRhino2BonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatRhino2FreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatRhino2CurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('GreatRhino2BonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $slotSettings->SetGameData('GreatRhino2FreeBalance', $Balance);
                                $slotSettings->SetGameData('GreatRhino2TotalWin', 0);
                                $slotSettings->SetGameData('GreatRhino2BonusState', 0);
                                $slotSettings->SetGameData('GreatRhino2BonusWin', $totalWin);
                            }
