                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'bonusSymbol', rand(1, 3));
