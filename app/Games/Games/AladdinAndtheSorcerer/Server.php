            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('AladdinAndtheSorcererBonusWin', 0);
                        $slotSettings->SetGameData('AladdinAndtheSorcererFreeGames', 0);
                        $slotSettings->SetGameData('AladdinAndtheSorcererCurrentFreeGame', 0);
                        $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('AladdinAndtheSorcererBonusState', 0);
                        $slotSettings->SetGameData('AladdinAndtheSorcererBonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('AladdinAndtheSorcererDealerCard');
                        $totalWin = $slotSettings->GetGameData('AladdinAndtheSorcererTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('AladdinAndtheSorcererDealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') <= $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') && $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('AladdinAndtheSorcererCurrentFreeGame', $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('AladdinAndtheSorcererBonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') == 0 ) 
                            {
                                $slotSettings->SetGameData('AladdinAndtheSorcererBonusMpl', 1);
                                $slotSettings->SetGameData('AladdinAndtheSorcererFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('AladdinAndtheSorcererCurrentFreeGame', 1);
                                $spinType = 's&fsmul=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') . '&fswin=' . $totalWin . '&fs=1&fsres=' . $totalWin;
                            }
                            else
                            {
                                $slotSettings->SetGameData('AladdinAndtheSorcererFreeGames', $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') + $slotSettings->slotFreeCount);
                            }
                        }
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('AladdinAndtheSorcererBonusWin', $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin') + $totalWin);
                            $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', $slotSettings->GetGameData('AladdinAndtheSorcererTotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('AladdinAndtheSorcererFreeBalance');
                            if( $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') + 1 <= $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') && $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') . '&fswin=' . $slotSettings->GetGameData('AladdinAndtheSorcererTotalWin') . '&fs=' . $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', $totalWin);
                            $slotSettings->SetGameData('AladdinAndtheSorcererBonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&n_reel_set=0&counter=' . ((int)$postData['counter'] + 1) . '&l=20&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') + 1 <= $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') && $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', 0);
                            $slotSettings->SetGameData('AladdinAndtheSorcererBonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('AladdinAndtheSorcererFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AladdinAndtheSorcererCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('AladdinAndtheSorcererBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $slotSettings->SetGameData('AladdinAndtheSorcererFreeBalance', $Balance);
                                $slotSettings->SetGameData('AladdinAndtheSorcererTotalWin', 0);
                                $slotSettings->SetGameData('AladdinAndtheSorcererBonusState', 0);
                                $slotSettings->SetGameData('AladdinAndtheSorcererBonusWin', $totalWin);
                            }
