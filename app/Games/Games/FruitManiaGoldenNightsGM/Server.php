                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            ...
                                            {
                                                $animStr = 'smallWin' . $reels['reel' . $r][$p];
                                                $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:4:"SWx' . $reels['reel' . $r][$p] . '";}';
                                                $winCountAnim++;
                                            }
                                        }
                                    }
                                ...
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[0] .= ('i:2;i:' . $reels['reel1'][2] . ';i:3;i:' . $reels['reel1'][1] . ';i:4;i:' . $reels['reel1'][0] . ';i:5;i:' . $rsym . ';}');
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[1] .= ('i:5;i:' . $reels['reel2'][2] . ';i:6;i:' . $reels['reel2'][1] . ';i:7;i:' . $reels['reel2'][0] . ';i:8;i:' . $rsym . ';}');
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[2] .= ('i:8;i:' . $reels['reel3'][2] . ';i:9;i:' . $reels['reel3'][1] . ';i:10;i:' . $reels['reel3'][0] . ';i:11;i:' . $rsym . ';}');
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[3] .= ('i:11;i:' . $reels['reel4'][2] . ';i:12;i:' . $reels['reel4'][1] . ';i:13;i:' . $reels['reel4'][0] . ';i:14;i:' . $rsym . ';}');
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[4] .= ('i:14;i:' . $reels['reel5'][2] . ';i:15;i:' . $reels['reel5'][1] . ';i:16;i:' . $reels['reel5'][0] . ';i:17;i:' . $rsym . ';}');
                                $wwCnt = 0;
                                $wwStr = '';
                                $wwStr2 = '';
                                for( $ww = 0; $ww < $lines; $ww++ ) 
                                {
                                    if( $cWins[$ww] > 0 ) 
                                    {
                                        ...
                                        $wwStr2 .= ('i:' . ($ww + 1) . ';i:' . ($cWins[$ww] / $betline) . ';');
                                    }
                                }
                                if( $scattersCount >= 3 ) 
                                {
                                ...
                                $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"spinresult";s:5:"value";a:47:{s:8:"winCoins";i:' . ($totalWin * 100) . ';s:8:"winLines";' . $winString . 's:13:"winLinesCount";i:' . $wwCnt . ';s:10:"winPerLine";' . $wins_ . 's:12:"winFGPerLine";b:0;s:13:"bonusWinLines";b:0;s:15:"bonusWinPerLine";b:0;s:11:"bonusSymbol";b:0;s:11:"fiveOfAKind";b:0;s:9:"freeGames";b:0;s:11:"actFreegame";b:0;s:12:"maxFreegames";b:0;s:11:"freegameWin";b:0;s:10:"isFreeGame";b:0;s:12:"wonFreegames";b:0;s:11:"playerCoins";i:' . $balanceInCents . ';s:9:"winFactor";d:' . ($totalWin / $betline) . ';s:3:"x25";b:0;s:11:"symbolAnims";' . $symbolAnims . 's:9:"blockAnim";b:0;s:12:"blockAnimPos";b:0;s:15:"actWinFreegames";b:0;s:19:"freeGamesAnimations";b:0;s:13:"replaceSymbol";b:0;s:9:"multiData";b:0;s:10:"totalMulti";b:0;s:8:"maxiplay";b:0;s:18:"additionalWinAnims";b:0;s:10:"multiLines";b:0;s:15:"specSymbolAnims";b:0;s:16:"extraTeaserReels";b:0;s:11:"stickyReels";b:0;s:12:"newStickyPos";b:0;s:19:"playRandomRetrigger";b:0;s:19:"wildSymbolPositions";b:0;s:12:"bonusSymbols";b:0;s:13:"isBookFeature";b:0;s:12:"actFreeRound";i:0;s:13:"maxFreeRounds";i:0;s:12:"freeRoundWin";i:0;s:16:"winLineWinFactor";' . $wins_2 . 's:13:"amountSymbols";a:5:{s:1:"a";i:6;s:1:"b";i:9;s:1:"c";i:12;s:1:"d";i:15;s:1:"e";i:18;}s:17:"reel_a_symboldata";' . $reelStr[0] . 's:17:"reel_b_symboldata";' . $reelStr[1] . 's:17:"reel_c_symboldata";' . $reelStr[2] . 's:17:"reel_d_symboldata";' . $reelStr[3] . 's:17:"reel_e_symboldata";' . $reelStr[4] . 's:11:"jackpotGame";' . $jackpotInfo . '}}}}}';
                                break;
                            case 'initGambleCard':
