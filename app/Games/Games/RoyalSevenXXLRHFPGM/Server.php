                        ...
                        switch( $aid ) 
                        {
                            case 'init':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $r1 = 'i:0;i:' . $reels['reel1'][3] . ';i:1;i:' . $reels['reel1'][2] . ';i:2;i:' . $reels['reel1'][1] . ';i:3;i:' . $reels['reel1'][0] . ';i:4;i:' . rand(1, 6) . ';';
                                    $r2 = 'i:0;i:' . $reels['reel2'][3] . ';i:1;i:' . $reels['reel2'][2] . ';i:2;i:' . $reels['reel2'][1] . ';i:3;i:' . $reels['reel2'][0] . ';i:4;i:' . rand(1, 6) . ';';
                                    $r3 = 'i:0;i:' . $reels['reel3'][3] . ';i:1;i:' . $reels['reel3'][2] . ';i:2;i:' . $reels['reel3'][1] . ';i:3;i:' . $reels['reel3'][0] . ';i:4;i:' . rand(1, 6) . ';';
                                    $r4 = 'i:0;i:' . $reels['reel3'][3] . ';i:1;i:' . $reels['reel4'][2] . ';i:2;i:' . $reels['reel4'][1] . ';i:3;i:' . $reels['reel4'][0] . ';i:4;i:' . rand(1, 6) . ';';
                                    $r5 = 'i:0;i:' . $reels['reel3'][3] . ';i:1;i:' . $reels['reel5'][2] . ';i:2;i:' . $reels['reel5'][1] . ';i:3;i:' . $reels['reel5'][0] . ';i:4;i:' . rand(1, 6) . ';';
                                    $actFreegame = 0;
                                }
                                else
                                {
                                    ...
                                    $r1 = 'i:0;i:' . rand(1, 7) . ';i:1;i:' . rand(1, 7) . ';i:2;i:' . rand(1, 7) . ';i:3;i:' . rand(1, 7) . ';' . 'i:4;i:' . rand(1, 7) . ';';
                                    $r2 = 'i:0;i:' . rand(1, 7) . ';i:1;i:' . rand(1, 7) . ';i:2;i:' . rand(1, 7) . ';i:3;i:' . rand(1, 7) . ';' . 'i:4;i:' . rand(1, 7) . ';';
                                    $r3 = 'i:0;i:' . rand(1, 7) . ';i:1;i:' . rand(1, 7) . ';i:2;i:' . rand(1, 7) . ';i:3;i:' . rand(1, 7) . ';' . 'i:4;i:' . rand(1, 7) . ';';
                                    $r4 = 'i:0;i:' . rand(1, 7) . ';i:1;i:' . rand(1, 7) . ';i:2;i:' . rand(1, 7) . ';i:3;i:' . rand(1, 7) . ';' . 'i:4;i:' . rand(1, 7) . ';';
                                    $r5 = 'i:0;i:' . rand(1, 7) . ';i:1;i:' . rand(1, 7) . ';i:2;i:' . rand(1, 7) . ';i:3;i:' . rand(1, 7) . ';' . 'i:4;i:' . rand(1, 7) . ';';
                                }
                            ...
                            case 'spin':
                                ...
                                for( $rlp = 0; $rlp < 5; $rlp++ ) 
                                {
                                    ...
                                    for( $rlp0 = 0; $rlp0 < ($rsCount[$rlp] - 4); $rlp0++ ) 
                                    {
                                        ...
                                        $reelStr[$rlp] .= ('i:' . $rlp0 . ';i:' . $reels['reel' . ($rlp + 1)][3] . ';');
                                    }
                                }
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                                $reelStr[0] .= 'i:2;i:1;i:3;i:2;i:4;i:3;i:5;i:4;}';
                                $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
