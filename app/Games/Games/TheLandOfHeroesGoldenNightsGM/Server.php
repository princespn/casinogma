                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $reels2 = $reels;
                                    $winCount = 1;
                                    $bonusSymbolArr = $slotSettings->GetGameData($slotSettings->slotId . 'BonusSymbol');
                                    for( $bsc = 0; $bsc < count($bonusSymbolArr); $bsc++ ) 
                                    {
                                        $wild[] = '' . $bonusSymbolArr[$bsc];
                                    }
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        $tmpStringWin = '';
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels2['reel' . $r][$p] == -1 ) 
                                            {
                                                ...
                                                if( in_array($reels['reel' . $r][$p], $bonusSymbolArr) ) 
                                                {
                                                    $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:4:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:10:"goldenWild";s:6:"symbol";i:' . $reels['reel' . $r][$p] . ';}';
                                                }
                                                $winCountAnim++;
                                            }
                                        }
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $bsRandCnt = rand(1, 4);
                                        $bonusSymbolTmp = [];
                                        for( $bsc = 0; $bsc < $bsRandCnt; $bsc++ ) 
                                        {
                                            $bonusSymbolTmp[] = $bsRandArr[$bsc];
                                        }
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusSymbol', $bonusSymbolTmp);
                                    }
                                ...
                                for( $bsc = 0; $bsc < count($bonusSymbolArr); $bsc++ ) 
                                {
                                    $bonusSymbolArrStr[] = 'i:' . $bsc . ';i:' . $bonusSymbolArr[$bsc] . ';';
                                }
                                $bonusSymbol = 'a:' . count($bonusSymbolArr) . ':{' . implode('', $bonusSymbolArrStr) . '}';
