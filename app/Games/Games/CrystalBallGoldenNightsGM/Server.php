                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'applyUserRequest':
                                ...
                                if( $req == 'linebetplus' ) 
                                {
                                    ...
                                    $tbets[4] = ($bet * $lines * $slotSettings->FirepotBetRate[4]) / 10 * 100;
                                    ...
                                    $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:2:{i:0;a:2:{s:4:"type";s:15:"possJackpotBets";s:5:"value";a:2:{s:8:"possBets";a:5:{i:0;i:0;i:1;i:' . $tbets[1] . ';i:2;i:' . $tbets[2] . ';i:3;i:' . $tbets[3] . ';i:4;i:' . $tbets[4] . ';}s:8:"infoData";a:5:{s:3:"bet";i:' . $tbets[0] . ';s:6:"topWin";i:' . ($bet * $lines * $slotSettings->FirepotPaytable[$fpb][6] * 100) . ';s:20:"topWinOnHighestLevel";i:0;s:10:"allTopWins";a:4:{i:' . $tbets[1] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[1][6] * 100) . ';i:' . $tbets[2] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[2][6] * 100) . ';i:' . $tbets[3] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[3][6] * 100) . ';i:' . $tbets[4] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[4][6] * 100) . ';}s:5:"bonus";i:' . $addScore[$fpb] . ';}}}i:1;a:2:{s:4:"type";s:7:"linebet";s:5:"value";i:' . ($cbet * 100) . ';}}}';
                            ...
                            case 'increaseJackpotBet':
                                ...
                                $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"jackpotBet";s:5:"value";a:5:{s:3:"bet";i:' . $tbets[0] . ';s:6:"topWin";i:' . ($bet * $lines * $slotSettings->FirepotPaytable[$fpb][6] * 100) . ';s:20:"topWinOnHighestLevel";i:' . ($bet * $lines * $slotSettings->FirepotPaytable[$fpb][7] * 100) . ';s:10:"allTopWins";a:4:{i:' . $tbets[1] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[1][6] * 100) . ';i:' . $tbets[2] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[2][6] * 100) . ';i:' . $tbets[3] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[3][6] * 100) . ';i:' . $tbets[4] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[4][6] * 100) . ';}s:5:"bonus";i:' . $addScore[$fpb] . ';}}}}';
                                break;
                            ...
                            case 'spin':
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        ...
                                        for( $r = 1; $r <= 5; $r++ ) 
                                        {
                                            if( $reels['reel' . $r][0] == $bs || $reels['reel' . $r][1] == $bs || $reels['reel' . $r][2] == $bs ) 
                                            {
                                                $bwlTempl .= ('i:' . $r . ';i:' . $bs . ';');
                                                $bwlCnt++;
                                                $bwlFill[] = 's:1:"' . $bwlFill_i[$r] . '";a:3:{i:0;i:' . $bs . ';i:1;i:' . $bs . ';i:2;i:' . $bs . ';}';
                                            }
                                            else
                                            {
                                                $bwlTempl .= ('i:' . $r . ';b:0;');
                                        ...
                                        $bwlWin = $slotSettings->Paytable['SYM_' . $bs][$bwlCnt] * $allbet;
                                        $bwlWin0 = $slotSettings->Paytable['SYM_' . $bs][$bwlCnt] * $betline;
                                        if( $bwlWin > 0 ) 
                                        {
                                            for( $r = 0; $r < $lines; $r++ ) 
                                            {
                                                $bwlTmpArr[] = 'i:' . $r . ';a:6:{i:0;i:' . ($r + 1) . ';' . $bwlTempl . '}';
                                                $bwlTmpArr0[] = 'i:' . ($r + 1) . ';i:' . ($bwlWin0 * 100) . ';';
                                            }
                                        }
                                        else
                                        {
                                        ...
                                        $bonusWinLines = 'a:' . count($bwlTmpArr) . ':{' . implode('', $bwlTmpArr) . '}';
                                        $bonusWinPerLine = 'a:' . count($bwlTmpArr0) . ':{' . implode('', $bwlTmpArr0) . '}';
                                        $copySymbolsOnReels = 'a:' . count($bwlFill) . ':{' . implode('', $bwlFill) . '}';
                                    }
                                    else
                                    {
                                        $bonusWinLines = 'b:0;';
                                        ...
                                        else
                                        {
                                            ...
                                            if( $chanceFirepot == 1 && $postData['slotEvent'] != 'freespin' ) 
                                            {
                                                ...
                                                if( $fireCount[0] >= 3 ) 
                                                {
                                                    ...
                                                    $jackpotInfo = 'a:2:{s:7:"actStep";i:1;s:6:"result";a:9:{s:6:"chance";a:3:{i:0;b:1;i:1;b:1;i:2;b:1;}s:11:"initSymbols";a:5:{i:0;a:2:{i:0;i:' . $fireReelsInit[0] . ';i:1;i:' . $fireReelsInit[0] . ';}i:1;a:2:{i:0;i:' . $fireReelsInit[1] . ';i:1;i:' . $fireReelsInit[1] . ';}i:2;a:2:{i:0;i:' . $fireReelsInit[2] . ';i:1;i:' . $fireReelsInit[2] . ';}i:3;a:2:{i:0;i:' . $fireReelsInit[3] . ';i:1;i:' . $fireReelsInit[3] . ';}i:4;a:2:{i:0;i:' . $fireReelsInit[4] . ';i:1;i:' . $fireReelsInit[4] . ';}}' . $spinSymbolsJack . 's:14:"levelWinValues";a:7:{i:0;i:' . ($slotSettings->FirepotPaytable[$frate][1] * $allbet * 100) . ';i:1;i:' . ($slotSettings->FirepotPaytable[$frate][2] * $allbet * 100) . ';i:2;i:' . ($slotSettings->FirepotPaytable[$frate][3] * $allbet * 100) . ';i:3;i:' . ($slotSettings->FirepotPaytable[$frate][4] * $allbet * 100) . ';i:4;i:' . ($slotSettings->FirepotPaytable[$frate][5] * $allbet * 100) . ';i:5;i:' . ($slotSettings->FirepotPaytable[$frate][6] * $allbet * 100) . ';i:6;i:' . ($slotSettings->FirepotPaytable[$frate][7] * $allbet * 100) . ';}s:14:"transformReels";a:5:{i:0;' . $transformReels[0] . 'i:1;' . $transformReels[1] . 'i:2;' . $transformReels[2] . 'i:3;' . $transformReels[3] . 'i:4;' . $transformReels[4] . '}s:13:"pointsPerReel";a:5:{i:0;i:' . $fireReelsArr[0][0] . ';i:1;i:' . $fireReelsArr[1][0] . ';i:2;i:' . $fireReelsArr[2][0] . ';i:3;i:' . $fireReelsArr[3][0] . ';i:4;i:' . $fireReelsArr[4][0] . ';}s:11:"startPoints";i:' . $startPoints . ';s:8:"totalWin";i:' . ($currentFireWin * 100) . ';s:11:"lastSpinWin";i:' . ($lastSpinWin * 100) . ';}}}';
                                                }
                                                else
                                                {
                                                    $caseArr = [
                                ...
                                $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"spinresult";s:5:"value";a:49:{s:8:"winCoins";i:' . ($totalWin * 100) . ';s:8:"winLines";' . $winString . 's:13:"winLinesCount";i:' . $wwCnt . ';s:10:"winPerLine";' . $wins_ . 's:12:"winFGPerLine";b:0;s:13:"bonusWinLines";' . $bonusWinLines . 's:15:"bonusWinPerLine";' . $bonusWinPerLine . 's:11:"bonusSymbol";' . $bSym . ';s:11:"fiveOfAKind";b:0;s:9:"freeGames";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ';s:11:"actFreegame";i:' . $actFreegame . ';s:12:"maxFreegames";i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';s:11:"freegameWin";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ';s:10:"isFreeGame";b:' . $isFreeGame . ';s:12:"wonFreegames";i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';s:11:"playerCoins";i:' . $balanceInCents . ';s:9:"winFactor";d:' . ($totalWin / $betline) . ';s:3:"x25";b:0;s:11:"symbolAnims";' . $symbolAnims . 's:9:"blockAnim";b:0;s:12:"blockAnimPos";b:0;s:15:"actWinFreegames";b:0;s:19:"freeGamesAnimations";b:0;s:13:"replaceSymbol";b:0;s:9:"multiData";b:0;s:10:"totalMulti";b:0;s:8:"maxiplay";b:0;s:18:"additionalWinAnims";b:0;s:10:"multiLines";b:0;s:15:"specSymbolAnims";b:0;s:16:"extraTeaserReels";b:0;s:11:"stickyReels";b:0;s:12:"newStickyPos";b:0;s:19:"playRandomRetrigger";b:0;s:19:"wildSymbolPositions";b:0;s:12:"bonusSymbols";b:0;s:13:"isBookFeature";b:0;s:12:"actFreeRound";i:0;s:13:"maxFreeRounds";i:0;s:12:"freeRoundWin";i:0;s:14:"attentionSpins";a:5:{s:1:"a";i:0;s:1:"b";i:0;s:1:"c";i:0;s:1:"d";i:0;s:1:"e";i:0;}s:11:"teaserReels";' . $teaserReels . 's:13:"amountSymbols";a:5:{s:1:"a";i:8;s:1:"b";i:12;s:1:"c";i:16;s:1:"d";i:20;s:1:"e";i:24;}s:17:"reel_a_symboldata";' . $reelStr[0] . 's:17:"reel_b_symboldata";' . $reelStr[1] . 's:17:"reel_c_symboldata";' . $reelStr[2] . 's:17:"reel_d_symboldata";' . $reelStr[3] . 's:17:"reel_e_symboldata";' . $reelStr[4] . 's:11:"jackpotGame";' . $jackpotInfo . '}}}}';
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $teaserReelsArr = [
                                        's:1:"a";b:0;', 
                                    ...
                                    $teaserReels = 'a:5:{' . implode('', $teaserReelsArr) . '}';
                                    $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"spinresult";s:5:"value";a:51:{s:8:"winCoins";i:' . ($totalWin * 100) . ';s:8:"winLines";' . $winString . 's:13:"winLinesCount";i:' . $wwCnt . ';s:10:"winPerLine";' . $wins_ . 's:12:"winFGPerLine";b:0;s:13:"bonusWinLines";' . $bonusWinLines . 's:15:"bonusWinPerLine";' . $bonusWinPerLine . 's:11:"bonusSymbol";' . $bSym . ';s:11:"fiveOfAKind";b:0;s:9:"freeGames";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ';s:11:"actFreegame";i:' . $actFreegame . ';s:12:"maxFreegames";i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';s:11:"freegameWin";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ';s:10:"isFreeGame";b:1;s:12:"wonFreegames";i:0;s:11:"playerCoins";i:' . $balanceInCents . ';s:9:"winFactor";d:' . ($totalWin / $betline) . ';s:3:"x25";b:0;s:11:"symbolAnims";' . $symbolAnims . 's:9:"blockAnim";b:0;s:12:"blockAnimPos";b:0;s:15:"actWinFreegames";b:0;s:19:"freeGamesAnimations";b:0;s:13:"replaceSymbol";b:0;s:9:"multiData";b:0;s:10:"totalMulti";b:0;s:8:"maxiplay";b:0;s:18:"additionalWinAnims";b:0;s:10:"multiLines";b:0;s:15:"specSymbolAnims";b:0;s:16:"extraTeaserReels";b:0;s:11:"stickyReels";b:0;s:12:"newStickyPos";b:0;s:19:"playRandomRetrigger";b:0;s:19:"wildSymbolPositions";b:0;s:12:"bonusSymbols";b:0;s:13:"isBookFeature";b:0;s:12:"actFreeRound";i:0;s:13:"maxFreeRounds";i:0;s:12:"freeRoundWin";i:0;s:14:"attentionSpins";a:5:{s:1:"a";i:0;s:1:"b";i:0;s:1:"c";i:0;s:1:"d";i:0;s:1:"e";i:0;}s:11:"teaserReels";' . $teaserReels . 's:13:"amountSymbols";a:5:{s:1:"a";i:8;s:1:"b";i:12;s:1:"c";i:16;s:1:"d";i:20;s:1:"e";i:24;}s:18:"copySymbolsOnReels";' . $copySymbolsOnReels . 's:20:"winFactorBeforeStamp";d:0;s:17:"reel_a_symboldata";' . $reelStr[0] . 's:17:"reel_b_symboldata";' . $reelStr[1] . 's:17:"reel_c_symboldata";' . $reelStr[2] . 's:17:"reel_d_symboldata";' . $reelStr[3] . 's:17:"reel_e_symboldata";' . $reelStr[4] . 's:11:"jackpotGame";' . $jackpotInfo . '}}}}}';
                                }
                                break;
                            case 'initGambleCard':
