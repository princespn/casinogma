            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('GreatRhinoDeluxeBonusWin', 0);
                        $slotSettings->SetGameData('GreatRhinoDeluxeFreeGames', 0);
                        $slotSettings->SetGameData('GreatRhinoDeluxeCurrentFreeGame', 0);
                        $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('GreatRhinoDeluxeBonusState', 0);
                        $slotSettings->SetGameData('GreatRhinoDeluxeBonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('GreatRhinoDeluxeDealerCard');
                        $totalWin = $slotSettings->GetGameData('GreatRhinoDeluxeTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('GreatRhinoDeluxeDealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') <= $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') && $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('GreatRhinoDeluxeCurrentFreeGame', $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('GreatRhinoDeluxeBonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') == 0 ) 
                            {
                                $slotSettings->SetGameData('GreatRhinoDeluxeBonusMpl', 1);
                                $slotSettings->SetGameData('GreatRhinoDeluxeFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('GreatRhinoDeluxeCurrentFreeGame', 1);
                                $spinType = 's&fsmul=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') . '&fswin=' . $totalWin . '&fs=1&fsres=' . $totalWin;
                            }
                            else
                            {
                                $slotSettings->SetGameData('GreatRhinoDeluxeFreeGames', $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') + $slotSettings->slotFreeCount);
                            }
                        }
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('GreatRhinoDeluxeBonusWin', $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin') + $totalWin);
                            $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', $slotSettings->GetGameData('GreatRhinoDeluxeTotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('GreatRhinoDeluxeFreeBalance');
                            if( $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') + 1 <= $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') && $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') . '&fswin=' . $slotSettings->GetGameData('GreatRhinoDeluxeTotalWin') . '&fs=' . $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', $totalWin);
                            $slotSettings->SetGameData('GreatRhinoDeluxeBonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&n_reel_set=0&counter=' . ((int)$postData['counter'] + 1) . '&l=20&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') + 1 <= $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') && $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', 0);
                            $slotSettings->SetGameData('GreatRhinoDeluxeBonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatRhinoDeluxeFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatRhinoDeluxeCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('GreatRhinoDeluxeBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $slotSettings->SetGameData('GreatRhinoDeluxeFreeBalance', $Balance);
                                $slotSettings->SetGameData('GreatRhinoDeluxeTotalWin', 0);
                                $slotSettings->SetGameData('GreatRhinoDeluxeBonusState', 0);
                                $slotSettings->SetGameData('GreatRhinoDeluxeBonusWin', $totalWin);
                            }
