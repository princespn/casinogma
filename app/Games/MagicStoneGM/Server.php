                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $isStone ) 
                                    {
                                        ...
                                        for( $r = 1; $r <= 5; $r++ ) 
                                        {
                                            for( $p = 0; $p <= 2; $p++ ) 
                                            {
                                                if( $reels['reel' . $r][$p] == $bonusSymbolsArr[0] || $reels['reel' . $r][$p] == $bonusSymbolsArr[1] ) 
                                                {
                                                    $wildSymbolPositionsArr[] = 'i:' . $wc . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:6:"symbol";i:' . $reels['reel' . $r][$p] . ';}';
                                                    $wc++;
                                                }
                                            }
                                        }
                                        $wildSymbolPositions = 'a:' . count($wildSymbolPositionsArr) . ':{' . implode('', $wildSymbolPositionsArr) . '}';
                                    }
                                    $symbolAnimsArr = [];
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels2['reel' . $r][$p] == -1 ) 
                                            {
                                                ...
                                                {
                                                    $animStr = 'wild';
                                                    $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:7:"topWild";}';
                                                }
                                                else if( $reels['reel' . $r][$p] == $bonusSymbolsArr[0] || $reels['reel' . $r][$p] == $bonusSymbolsArr[1] ) 
                                                {
                                                    $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:4:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:10:"goldenWild";s:6:"symbol";i:' . $reels['reel' . $r][$p] . ';}';
                                                }
                                                else if( $reels['reel' . $r][$p] == 12 ) 
                                                {
                                                    $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:9:"stoneWild";}';
                                                }
                                                $winCountAnim++;
                                            }
                                        }
                                ...
                                if( $isStone ) 
                                {
                                    $bonusSymbols = 'a:2:{i:0;i:' . $bonusSymbolsArr[0] . ';i:1;i:' . $bonusSymbolsArr[1] . ';}';
                                }
                                else
                                {
                                    $bonusSymbols = 'b:0;';
                                    $extraTeaserReels = 'b:0;';
                                    $wildSymbolPositions = 'a:0:{}';
                                }
                                ...
                                $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"spinresult";s:5:"value";a:46:{s:8:"winCoins";i:' . ($totalWin * 100) . ';s:8:"winLines";' . $winString . 's:13:"winLinesCount";i:' . $wwCnt . ';s:10:"winPerLine";' . $wins_ . 's:12:"winFGPerLine";b:0;s:13:"bonusWinLines";b:0;s:15:"bonusWinPerLine";b:0;s:11:"bonusSymbol";b:0;s:11:"fiveOfAKind";b:0;s:9:"freeGames";b:0;s:11:"actFreegame";b:0;s:12:"maxFreegames";b:0;s:11:"freegameWin";b:0;s:10:"isFreeGame";b:0;s:12:"wonFreegames";b:0;s:11:"playerCoins";i:' . $balanceInCents . ';s:9:"winFactor";d:' . ($totalWin / $allbet) . ';s:3:"x25";b:0;s:11:"symbolAnims";' . $symbolAnims . 's:9:"blockAnim";b:0;s:12:"blockAnimPos";b:0;s:15:"actWinFreegames";b:0;s:19:"freeGamesAnimations";b:0;s:13:"replaceSymbol";b:0;s:9:"multiData";b:0;s:10:"totalMulti";b:0;s:8:"maxiplay";b:0;s:18:"additionalWinAnims";b:0;s:10:"multiLines";b:0;s:15:"specSymbolAnims";b:0;s:16:"extraTeaserReels";' . $extraTeaserReels . 's:11:"stickyReels";b:0;s:12:"newStickyPos";b:0;s:19:"playRandomRetrigger";b:0;s:19:"wildSymbolPositions";' . $wildSymbolPositions . 's:12:"bonusSymbols";' . $bonusSymbols . 's:13:"isBookFeature";b:0;s:12:"actFreeRound";i:0;s:13:"maxFreeRounds";i:0;s:12:"freeRoundWin";i:0;s:13:"amountSymbols";a:5:{s:1:"a";i:8;s:1:"b";i:12;s:1:"c";i:16;s:1:"d";i:20;s:1:"e";i:24;}s:17:"reel_a_symboldata";' . $reelStr[0] . 's:17:"reel_b_symboldata";' . $reelStr[1] . 's:17:"reel_c_symboldata";' . $reelStr[2] . 's:17:"reel_d_symboldata";' . $reelStr[3] . 's:17:"reel_e_symboldata";' . $reelStr[4] . '}}}}}';
                                break;
                            case 'initGambleCard':
