                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            case 'init':
                                ...
                                $slotSettings->SetGameData($slotSettings->slotId . 'Holds', [
                                    0, 
                                    0, 
                                    0, 
                                    0, 
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $lastEvent->serverResponse->Holds);
                            ...
                            case 'spin':
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        $presetData = json_decode(trim(file_get_contents(dirname(__FILE__) . '/presets/p_' . $wlb . '/preset_' . $lines . '.json')), true);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $reelsTmp = $reels;
                                    $winCount = 1;
                                    $Holds = $slotSettings->GetGameData($slotSettings->slotId . 'Holds');
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        if( $Holds[$r] == 1 && $postData['slotEvent'] == 'freespin' ) 
                                        {
                                            $reels['reel' . $r][0] = 9;
                                            $reels['reel' . $r][1] = 9;
                                            $reels['reel' . $r][2] = 9;
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        ...
                                        if( $postData['slotEvent'] == 'freespin' && ($reels['reel' . $r][0] == 9 || $reels['reel' . $r][1] == 9 || $reels['reel' . $r][2] == 9) ) 
                                        {
                                            $Holds[$r] = 1;
                                        }
                                    }
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels2['reel' . $r][$p] == -1 || $postData['slotEvent'] == 'freespin' && $Holds[$r] != 1 ) 
                                            {
                                                $wps = [
                                                    'T', 
                                                    'M', 
                                                ...
                                                if( $reels['reel' . $r][$p] == 9 ) 
                                                {
                                                    $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:5:"wild' . $wps[$p] . '";}';
                                                }
                                                $winCountAnim++;
                                            }
                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        if( $slotSettings->increaseRTP && $postData['slotEvent'] != 'freespin' && $winType == 'win' && $totalWin < ($minWin * $allbet) ) 
                                        {
                                        }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $Holds);
