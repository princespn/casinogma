                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $umid == '40186' ) 
                        {
                            ...
                            $cWin = $slotSettings->GetGameData('JacksOrBetterMHPTTotalWin');
                            $aWin = $cWin * 2;
                            ...
                            if( $isWin == 1 ) 
                            {
                                $pCard = rand($slotSettings->GetGameData('JacksOrBetterMHPTDCard'), 12);
                            }
                            else
                            {
                                $pCard = rand(0, $slotSettings->GetGameData('JacksOrBetterMHPTDCard'));
                            }
                            $resultCards = [
                                $slotSettings->GetGameData('JacksOrBetterMHPTDCardView'), 
                                $cardsArr[1], 
                                $cardsArr[2], 
                                $cardsArr[3], 
                                $cardsArr[4]
                            ...
                            if( $slotSettings->GetGameData('JacksOrBetterMHPTDCard') == $pCard ) 
                            {
                                $totalWin = $cWin;
                            }
                            else if( $slotSettings->GetGameData('JacksOrBetterMHPTDCard') < $pCard ) 
                            {
                                $totalWin = $aWin;
                            }
                            else
                            ...
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $result_tmp[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterMHPTDAmount') . ',"cWin":' . $cWin . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterMHPTDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($resultCards) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                            $result_tmp[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $balanceInCents . ',"deltaBalanceInCents":1},"ID":40085}';
                            if( $totalWin <= 0 ) 
                            {
                                $totalWin = -1 * $cWin;
                        ...
                        if( $umid == '40182' ) 
                        {
                            ...
                            $slotSettings->SetGameData('JacksOrBetterMHPTDCardView', $cardsArr[0]);
                            $slotSettings->SetGameData('JacksOrBetterMHPTDAmount', (double)$postData['amount']);
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $result_tmp[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterMHPTDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                            $result_tmp[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $balanceInCents . ',"deltaBalanceInCents":1},"ID":40085}';
                        }
                        if( $umid == '40179' ) 
                        {
                            $resultCards = $slotSettings->GetGameData('JacksOrBetterMHPTCurrentCards');
                            $cardsArr = $slotSettings->GetGameData('JacksOrBetterMHPTCards');
                            $BankReserved = $slotSettings->GetGameData('JacksOrBetterMHPTBankReserved');
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                for( $cc = 0; $cc < $ccLimit; $cc++ ) 
                                {
                                    ...
                                    $totalWin += (($payrate * $slotSettings->GetGameData('JacksOrBetterMHPTBet')) / $ccLimit);
                                    $tw[] = ($payrate * $slotSettings->GetGameData('JacksOrBetterMHPTBet')) / $ccLimit;
                                }
                                if( $totalWin <= $bank ) 
                                {
                                    break;
                        ...
                        if( $umid == '40175' ) 
                        {
                            ...
                            $slotSettings->SetGameData('JacksOrBetterMHPTCurrentCards', $resultCards);
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40294':
                                ...
                                $result_tmp[] = '3:::{"data":{"commandId":10713,"params":["0","ba","bj","ct","gc","grel","hb","jb_mh","ro","sc","tr"]},"ID":50001,"umid":9}';
