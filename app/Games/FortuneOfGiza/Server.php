            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('FortuneOfGizaBonusWin', 0);
                        $slotSettings->SetGameData('FortuneOfGizaFreeGames', 0);
                        $slotSettings->SetGameData('FortuneOfGizaCurrentFreeGame', 0);
                        $slotSettings->SetGameData('FortuneOfGizaTotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('FortuneOfGizaBonusState', 0);
                        $slotSettings->SetGameData('FortuneOfGizaBonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('FortuneOfGizaDealerCard');
                        $totalWin = $slotSettings->GetGameData('FortuneOfGizaTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('FortuneOfGizaTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('FortuneOfGizaDealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') <= $slotSettings->GetGameData('FortuneOfGizaFreeGames') && $slotSettings->GetGameData('FortuneOfGizaFreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('FortuneOfGizaCurrentFreeGame', $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('FortuneOfGizaBonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('FortuneOfGizaFreeGames') == 0 ) 
                            {
                                $slotSettings->SetGameData('FortuneOfGizaBonusMpl', 1);
                                $slotSettings->SetGameData('FortuneOfGizaFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('FortuneOfGizaCurrentFreeGame', 1);
                                $spinType = 's&fsmul=' . $slotSettings->GetGameData('FortuneOfGizaBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('FortuneOfGizaFreeGames') . '&fswin=' . $totalWin . '&fs=1&fsres=' . $totalWin;
                            }
                            else
                            {
                                $slotSettings->SetGameData('FortuneOfGizaFreeGames', $slotSettings->GetGameData('FortuneOfGizaFreeGames') + $slotSettings->slotFreeCount);
                            }
                        }
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('FortuneOfGizaBonusWin', $slotSettings->GetGameData('FortuneOfGizaBonusWin') + $totalWin);
                            $slotSettings->SetGameData('FortuneOfGizaTotalWin', $slotSettings->GetGameData('FortuneOfGizaTotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('FortuneOfGizaFreeBalance');
                            if( $slotSettings->GetGameData('FortuneOfGizaFreeGames') + 1 <= $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') && $slotSettings->GetGameData('FortuneOfGizaFreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('FortuneOfGizaFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('FortuneOfGizaBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('FortuneOfGizaBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('FortuneOfGizaBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('FortuneOfGizaBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('FortuneOfGizaFreeGames') . '&fswin=' . $slotSettings->GetGameData('FortuneOfGizaTotalWin') . '&fs=' . $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('FortuneOfGizaBonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('FortuneOfGizaTotalWin', $totalWin);
                            $slotSettings->SetGameData('FortuneOfGizaBonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('FortuneOfGizaBonusWin') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&n_reel_set=0&counter=' . ((int)$postData['counter'] + 1) . '&l=20&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('FortuneOfGizaFreeGames') + 1 <= $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') && $slotSettings->GetGameData('FortuneOfGizaFreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('FortuneOfGizaTotalWin', 0);
                            $slotSettings->SetGameData('FortuneOfGizaBonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('FortuneOfGizaBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('FortuneOfGizaFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FortuneOfGizaCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('FortuneOfGizaBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $slotSettings->SetGameData('FortuneOfGizaFreeBalance', $Balance);
                                $slotSettings->SetGameData('FortuneOfGizaTotalWin', 0);
                                $slotSettings->SetGameData('FortuneOfGizaBonusState', 0);
                                $slotSettings->SetGameData('FortuneOfGizaBonusWin', $totalWin);
                            }
