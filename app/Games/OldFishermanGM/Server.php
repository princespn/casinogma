                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                            ...
                                            else
                                            {
                                                ...
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                                {
                                                    ...
                                                    if( $csym == '12' && !$isBonus ) 
                                                    {
                                                        ...
                                                        $freeGameLine = 'a:3:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                                    }
                                                }
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                                {
                                                    ...
                                                    if( $cWins[$k] < $tmpWin ) 
                                                    {
                                                        ...
                                                        if( $csym == '12' && !$isBonus ) 
                                                        {
                                                            ...
                                                            $freeGameLine = 'a:4:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:3;a:3:{s:4:"reel";i:3;s:3:"pos";i:' . ($linesId[$k][3] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                                        }
                                                    }
                                                }
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                                {
                                                    ...
                                                    if( $cWins[$k] < $tmpWin ) 
                                                    {
                                                        ...
                                                        if( $csym == '12' && !$isBonus ) 
                                                        {
                                                            ...
                                                            $freeGameLine = 'a:5:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:3;a:3:{s:4:"reel";i:3;s:3:"pos";i:' . ($linesId[$k][3] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:4;a:3:{s:4:"reel";i:4;s:3:"pos";i:' . ($linesId[$k][4] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                                        }
                                                    }
                                                }
                                            }
                                ...
                                if( $isBonus ) 
                                {
                                    ...
                                    $actWinFreegames = 'i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';';
                                    $wins_fg = 'a:1:{i:' . $scattersCount[1] . ';i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';}';
