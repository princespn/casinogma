                        ...
                        switch( $aid ) 
                        {
                            case 'init':
                                ...
                                if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                                {
                                    ...
                                    $bonusSymbol = 'i:' . $slotSettings->GetGameData($slotSettings->slotId . 'BonusSymbol') . ';';
                                }
                                $betString = '';
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $scattersCount >= 9 || $scattersWin > 0 ) 
                                    {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            ...
                                            {
                                                if( in_array($reels['reel' . $r][$p], $wild) ) 
                                                {
                                    ...
                                    if( $slotSettings->MaxWin < $totalWin ) 
                                    {
                                    }
                                    else
                                    {
                                        ...
                                        else if( $scattersCount >= 9 && $winType != 'bonus' ) 
                                        {
                                        }
                                ...
                                if( $scattersCount >= 9 ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusSymbol', rand(6, 9));
