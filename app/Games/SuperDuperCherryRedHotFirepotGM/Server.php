                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'applyUserRequest':
                                ...
                                if( $req == 'linesplus' ) 
                                {
                                    ...
                                    $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:2:{i:0;a:2:{s:4:"type";s:15:"possJackpotBets";s:5:"value";a:2:{s:8:"possBets";a:4:{i:0;i:0;i:1;i:' . $tbets[1] . ';i:2;i:' . $tbets[2] . ';i:3;i:' . $tbets[3] . ';}s:8:"infoData";a:5:{s:3:"bet";i:' . $tbets[0] . ';s:6:"topWin";i:' . ($bet * $lines * $slotSettings->FirepotPaytable[$fpb][6] * 100) . ';s:20:"topWinOnHighestLevel";i:0;s:10:"allTopWins";a:3:{i:' . $tbets[1] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[1][6] * 100) . ';i:' . $tbets[2] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[2][6] * 100) . ';i:' . $tbets[3] . ';i:' . ($bet * $lines * $slotSettings->FirepotPaytable[3][6] * 100) . ';}s:5:"bonus";i:' . $addScore[$fpb] . ';}}}i:1;a:2:{s:4:"type";s:5:"lines";s:5:"value";i:' . $lines . ';}}}';
