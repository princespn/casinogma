                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'applyUserRequest':
                                ...
                                if( $req == 'linebetplus' ) 
                                {
                                    ...
                                    $result_tmp[0] = 'INFO$$1$$a:1:{s:7:"display";a:2:{i:0;a:2:{s:4:"type";s:15:"possJackpotBets";s:5:"value";a:2:{s:8:"possBets";a:5:{i:0;i:0;i:1;i:' . ($cbet * 100) . ';i:2;i:' . ($cbet * 100 * $slotSettings->FirepotBetRate[2]) . ';i:3;i:' . ($cbet * 100 * $slotSettings->FirepotBetRate[3]) . ';i:4;i:' . ($cbet * 100 * $slotSettings->FirepotBetRate[4]) . ';}s:8:"infoData";a:5:{s:3:"bet";i:' . ($fpb * $cbet) . ';s:6:"topWin";i:0;s:20:"topWinOnHighestLevel";i:0;s:10:"allTopWins";a:3:{i:80;i:800000;i:200;i:2000000;i:400;i:4000000;}s:5:"bonus";i:0;}}}i:1;a:2:{s:4:"type";s:7:"linebet";s:5:"value";i:' . ($cbet * 100) . ';}}}';
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        if( $reels['reel' . $r][0] == 9 || $reels['reel' . $r][1] == 9 || $reels['reel' . $r][2] == 9 ) 
                                        {
                                            $reels['reel' . $r][0] = 9;
                                            $reels['reel' . $r][1] = 9;
                                            $reels['reel' . $r][2] = 9;
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        ...
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            ...
                                            if( $reels3['reel' . $r][$p] == 9 ) 
                                            {
                                                $isWildExpandPos = $p;
                                            }
                                            if( $reels2['reel' . $r][$p] == -1 && $reels['reel' . $r][$p] == 9 ) 
                                            {
                                                $symbolAnimsArr[] = 'i:' . $winCountAnim . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:4:"wild";}';
                                                $winCountAnim++;
                                            }
                                        }
                                        if( $isWildExpand && $totalWin > 0 ) 
                                        {
                                            $prst = [
                                                'T', 
                                                'M', 
                                            ...
                                            $prst_ = $prst[$isWildExpandPos];
                                            $symbolAnimsArr2[] = 'i:' . $winCountAnim2 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:0;s:9:"animation";s:8:"expand' . $prst_ . '1";}';
                                            $winCountAnim2++;
                                            $symbolAnimsArr2[] = 'i:' . $winCountAnim2 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:1;s:9:"animation";s:8:"expand' . $prst_ . '2";}';
                                            $winCountAnim2++;
                                            $symbolAnimsArr2[] = 'i:' . $winCountAnim2 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:2;s:9:"animation";s:8:"expand' . $prst_ . '3";}';
                                            $winCountAnim2++;
                                        }
                                    }
                                    $reels = $reelsTmp;
                                ...
                                if( count($symbolAnimsArr2) > 0 ) 
                                {
                                    $symbolAnims2 = 'a:' . count($symbolAnimsArr2) . ':{' . implode('', $symbolAnimsArr2) . '}';
                                }
                                else
                                {
                                    $symbolAnims2 = 'b:0;';
