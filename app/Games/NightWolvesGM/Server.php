                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        ...
                                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if( $csym == '9' && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                                {
                                                    $mpl = 1;
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = 'i:' . $winCount . ';a:6:{i:0;i:' . ($k + 1) . ';i:1;b:0;i:2;b:0;i:3;i:' . $s[2] . ';i:4;i:' . $s[3] . ';i:5;i:' . $s[4] . ';}';
                                                        $reels2['reel3'][$linesId[$k][2] - 1] = -1;
                                                ...
                                                if( $csym == '9' && $s[4] == $csym && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                                {
                                                    $mpl = 1;
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = 'i:' . $winCount . ';a:6:{i:0;i:' . ($k + 1) . ';i:1;b:0;i:2;i:' . $s[1] . ';i:3;i:' . $s[2] . ';i:4;i:' . $s[3] . ';i:5;i:' . $s[4] . ';}';
                                                        $reels2['reel2'][$linesId[$k][1] - 1] = -1;
                                                        $reels2['reel3'][$linesId[$k][2] - 1] = -1;
                                                        $reels2['reel4'][$linesId[$k][3] - 1] = -1;
                                                        $reels2['reel5'][$linesId[$k][4] - 1] = -1;
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        $topCount = 0;
                                        $topA = '1';
                                        if( $reels2['reel' . $r][0] == -1 && $reels2['reel' . $r][1] == -1 && $reels2['reel' . $r][2] == -1 && $reels['reel' . $r][0] == 9 && $reels['reel' . $r][1] == 9 && $reels['reel' . $r][2] == 9 ) 
                                        {
                                            $topA = '3';
                                        }
                                        else if( $reels2['reel' . $r][1] == -1 && $reels2['reel' . $r][2] == -1 && $reels['reel' . $r][1] == 9 && $reels['reel' . $r][2] == 9 ) 
                                        {
                                            $topA = '2';
                                        }
                                        else if( $reels2['reel' . $r][0] == -1 && $reels2['reel' . $r][1] == -1 && $reels['reel' . $r][0] == 9 && $reels['reel' . $r][1] == 9 ) 
                                        {
                                            $topA = '2';
                                        }
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels2['reel' . $r][$p] == -1 ) 
                                            {
                                                ...
                                                {
                                                    $symbolAnimsArr[] = 's:4:"' . ($r - 1) . '§' . $p . '";a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:4:"wild";}';
                                                }
                                                else if( $reels['reel' . $r][$p] == 9 ) 
                                                {
                                                    $topId = [
                                                        't', 
                                                        'm', 
                                                    ...
                                                    $symbolAnimsArr[] = 's:4:"' . ($r - 1) . '§' . $p . '";a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:5:"top' . $topA . $topId[$topCount] . '";}';
                                                    $topCount++;
                                                }
                                                else
                                                {
