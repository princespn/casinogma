...
namespace VanguardLTE\Games\BonanzaGoldM
{
    ...
    use VanguardLTE\Games\PragmaticLib\Collect;
    use VanguardLTE\Games\PragmaticLib\GameSettings;
    use VanguardLTE\Games\PragmaticLib\Loader;
    use VanguardLTE\Games\PragmaticLib\Log;
    use VanguardLTE\Games\PragmaticLib\Spin;
