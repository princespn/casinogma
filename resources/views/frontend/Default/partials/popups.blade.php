    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-base ng-scope">
                ...
                <div>
                    <a style="color: black; font-size: 20px; display: flex; align-items: center; justify-content: center; cursor: pointer; " href="{{route('frontend.auth.google.login')}}">
                        <img src="/frontend/Default/img/google.png" style="height: 35px;">
                        &nbsp;&nbsp;&nbsp;Login with Google
                    </a>
                </div>
