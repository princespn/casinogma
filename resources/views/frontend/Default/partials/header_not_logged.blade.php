...
<header class="header">
    ...
    <div class="header__container">
        <div class="header__logo">
           <video style=" border-radius:15px 50px;border-color:#484347" width="200" height="112" muted autoplay loop>
  <source src="/frontend/Default/casinosweeps.mp4" type="video/mp4">
