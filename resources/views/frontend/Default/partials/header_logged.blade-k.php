                ...
                <form class="popup__form">
                    <div class="profile">
                        ...
                        <ul class="col-6 footer__item-acc-info" style="padding: 5px 0px;">
                            ...
                            <li class="font-black"><span class="info-name">@lang('app.pyour_bonus'):</span> <span class="info-value bonusValue">{{ number_format(auth()->user()->bonus, 2, '.', '') }}
                                    {{ isset($currency) ? $currency : 'USD' }}</span></li>
                            <li class="font-black"><span class="info-name">@lang('app.pyour_wager'):</span> <span class="info-value wager">{{ number_format(auth()->user()->wager, 2, '.', '') }}
                                    {{ isset($currency) ? $currency : 'USD' }}</span></li>
                            <!-- class disabled -->
                            @if (isset($refund) &&
                            $refund &&
...
<script>
    ...
    let contractAddresses = {
        ...
        // uuuu:'0x9ac64cc6e4415144c455bd8e4837fea55603e5c3'
    }
        ...
        if(ethereum && ethereum.selectedAddress){
            ...
            //     console.log(trxHash);
                $.ajax({
                    ...
                    type: "get",
                    // data: {hash : trxHash.transactionHash},
