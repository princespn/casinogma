...
<iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;" src='/games/JokersJewelPM/index.html?lang=en&cur=@if( auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif&gameSymbol=vs1dragon8&websiteUrl=&lobbyURL=' allowfullscreen>
