...
document.location.href=exitUrl;
    ...
    function moveRect() {
        if (window.history && window.history.pushState) {
            window.history.pushState('forward', null, 'https://jackpotmatic.com/game/ZodiacWheelEGT1?api_exit=/');
            window.location.href = "https://jackpotmatic.com/game/ZodiacWheelEGT1?api_exit=/";
        }
    }
