        ...
        <div class="sidebar-header">
            ...
            <div class="container text-center">
                <select class="selectpicker" id="lang" data-width="fit">
                    <option selected data-content='<span class="flag-icon flag-icon-gb"></span>'></option>
            ...
            <div class="row w-100 m-0">
                ...
                <div class="col-10 col-sm-6 text-sm-right text-center">
                    <div class="btn primary-btn d-inline-block mt-1 user-info">
                        <span class="custom-input-group-icon text-left" style="margin-right: 10px;"
                            data-toggle="tooltip" title="Username">
                            <i class="fas fa-user"></i>
                            <span id="user-username">{{ Auth::user()->username }}</span>
                        </span>
                        <span class="custom-input-group-icon text-left" style="margin: 10px;" id="hideMsg"
                            data-toggle="tooltip" title="Balance">
                            <i class="fas fa-wallet"></i>
                            <span id="user-balance">{{ number_format(Auth::user()->balance, 2, '.', ',') }}
                        ...
                        <span class="custom-input-group-icon text-left" style="margin-left: 10px;"
                            data-toggle="tooltip" title="Bonus">
                            <i class="fas fa-gift"></i>
                            <span id="user-cashback">{{ number_format(Auth::user()->count_return, 2, '.', ',') }}
                                @if (auth()->user()->present()->shop)
                                    {{ auth()->user()->present()->shop->currency }}
                                @endif
                            </span>
                ...
                <nav class="navbar navbar-expand p-0 scrollable-navbar">
                    <div>
                        <ul class="navbar-nav">
                            ...
                            @php
                                $companies = ['wazdan', 'arcade', 'netgame', 'betsoft', 'gdgames', 'cq9', 'playgt', 'vision', 'playngo', 'ka-gaming', 'mainama', 'skywind', 'pragmatic', 'novomatic', 'netent', 'igrosoft', 'greentube', 'casino-technology', 'aristocrat', 'amatic', 'playtech', 'gamomat', 'isoftbet', 'egt'];
                            @endphp

                            @if ($categories && count($categories))
                                @foreach ($categories as $index => $category)
                                    @if (!in_array($category->href, $companies))
                                        <li class="nav-item" data-sv="{{ $category->href }}"
                        ...
                        <nav class="navbar navbar-expand p-0 scrollable-navbar" id="vendors">
                            <ul class="navbar-nav">
                                @if ($categories && count($categories))
                                    @foreach ($categories as $index => $category)
                                        @if (in_array($category->href, $companies))
                                            <li class="nav-item mr-2 ml-2 box active"
                                                data-category="{{ $category->id }}">
                                                <a href="javascript: void(0);"><img
                                                        style="filter:brightness(0) invert(1);" class="nav-item-img"
                                                        src="/frontend/Tropicoblack/img/companies/{{ $category->href }}.png"></a>
                                            </li>
                                        @endif
                                    @endforeach
                                @endif
        ...
        <footer>
            <div class="row m-0">
                <div class="col-12 col-md-3 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <img src="/frontend/Tropicoblack/assets/images/ui/devices.png" alt=""
                            class="w-50 mb-1" />
                        <br />
                    ...
                    <div class="container">
                        <p class="text-justify">
                            ...
                            photographs are subject to copyright and may not be distributed without explicit written
                            consent of the Casino.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-3 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <img src="/frontend/Tropicoblack/assets/images/ui/secure_website.png" alt=""
                            class="w-50 mb-1" />
                        <p class="text-justify">
                            The the Online Casino has a legal permission to conduct online gambling on the basis of the
                            international License.
                            <br />
                            We understand that ensuring the fair game is one of the most important conditions for the
                            casino operation.
                            <br />
                    ...
                    <div class="container">
                        <div class="row m-0">
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/q1x2gaming.png"
                                        alt="q1x2gaming" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/amatic.png"
                                        alt="amatic" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/bomba.png"
                                        alt="bomba" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/egt.png"
                                        alt="egt" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/netent.png"
                                        alt="netent" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/novomatic.png"
                                        alt="novomatic" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/spin2win.png"
                                        alt="spin2win" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/frontend/Tropicoblack/assets/images/vendors/shadow/wazdan.png"
                                        alt="wazdan" style="max-width: 100px;" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-2 p-0 border-container">
                    ...
                    <div class="row m-0">
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/facebook.png" alt="facebook"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/twitter.png" alt="twitter"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/youtube.png" alt="youtube"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/instagram.png" alt="instagram"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/linkedin.png" alt="linkedin"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/frontend/Tropicoblack/assets/images/ui/pinterest.png" alt="pinterest"
                                    class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-2 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <h6>24/7 Support</h6>
                        <img src="/frontend/Tropicoblack/assets/images/ui/18plus.png" alt="" class="mb-1"
