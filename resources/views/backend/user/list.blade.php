		...
		@endif
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<button type="button" class="btn btn-danger btn-sm" id="deleteAllSelectedRecords">Delete Selected</button>
				...
				<div class="box-body">
					<div class="table-responsive">
						<table class="table table-bordered table-striped">
							<thead>
							<tr>
							<th><input type="checkbox" class="chkCheckAll" />Select All</th>
...
@section('scripts')
	<script>
		...
		$(".chkCheckAll").click(function(){
			...
			$(".chkCheckAll").prop('checked', $(this).prop('checked'));
		});
