...
var responseStr='{"sys":"kiosk","data":{"data":{"ratio":1,"eventInfo":{"900004":{}},"NormalTable":[{"iTableID":1,"ArraySeat":[0,0,0,0]},{"iTableID":2,"ArraySeat":[0,0,0,0]},{"iTableID":3,"ArraySeat":[0,0,0,0]},{"iTableID":4,"ArraySeat":[0,0,0,0]},{"iTableID":5,"ArraySeat":[0,0,0,0]},{"iTableID":6,"ArraySeat":[0,0,0,0]}],"highRollerBetRange":[20,30,40,50,60,70,80,90,100,150,200,250,300,350,400,450,500],"normalBetRange":[5,10,15,20,25,30,35,40,45,50,60,70,80,90,100,150,200,250,300],"highRollerRoomNum":0,"normalRoomNum":6,"keepSeat":{},"HighRollerTable":[],"maxGate":10000000,"CannonBetRange":[11,11,11,12,12,12,21,21,21,22,22,22,31,31,31,32,32,32,32],"minGate":0}},"sn":"'+curTime.getTime()+'","ret":"PlayerJoin"}';
var s=responseStr.length;
var ss=['0','0','0','0'];
ss.splice(0,s.toString().length);
responseL=ss.join("")+s;
...
var responseStr='{"sys":"fish_player","cmd":"init_player","data":{"vip_lv":null,"timestamp":'+curTime.getTime()+',"seat":0,"bet_type":0,"entries":'+_self.gameBalanceInCents+',"bet_list":[5,10,15,20,25,30,35,40,45,50,60,70,80,90,100,150,200,250,300],"bet_value":1,"coin":'+_self.gameBalanceInCents+',"id":"11357450","name":null,"weapon":0,"character":null,"winning":0.0,"lv":null}}';
var s=responseStr.length;
var ss=['0','0','0','0'];
ss.splice(0,s.toString().length);
responseL=ss.join("")+s;
...
var responseStr='{"sys":"fish","cmd":"f4","data":{"11":[],"timestamp":'+curTime.getTime()+',"13":1,"15":[],"14":0}}';
var s=responseStr.length;
var ss=['0','0','0','0'];
ss.splice(0,s.toString().length);
responseL=ss.join("")+s;
...
var responseStr='{"sys":"fish","cmd":"f6","data":{"1":"BG_02","timestamp":'+curTime.getTime()+',"2":2002}}';
var s=responseStr.length;
var ss=['0','0','0','0'];
ss.splice(0,s.toString().length);
responseL=ss.join("")+s;
...
var curTime  = new Date();
var responseStr='{"sys":"item","cmd":"get_item_info","data":{"timestamp":'+curTime.getTime()+',"MF100002":{"amount":"2","cd":2.0},"MF100001":{"amount":"5","cd":2.0}}}';
var s=responseStr.length;
var ss=['0','0','0','0'];
ss.splice(0,s.toString().length);
responseL=ss.join("")+s;
...
var responseStr='{"sys":"game","cmd":"join_table","data":{"player_id":"11357450","game_id":"07043080","timestamp":'+curTime.getTime()+',"seat":0}}';
