...
_self.fishesUpdateInterval=setInterval(_self.FishesUpdate,6000);	
...
var bulletBet=_self.gameData.Bet;	
...
if(utils.FixNumber(balanceInCents)<Bet){
...
var response ='{"answerType":"game.colliderResult","Win":'+(totalWin*100)+',"Balance":'+(startBalance)+',"curBet":'+_self.gameData.Bet+',"responseView":[4,0,0,0,6,'+String('game.colliderResult').length+'],"msg":{"player":{"gender":0,"id":"accessKey|USD|'+sys.userName+'","gold":0,"delta":0,"gain":0,"cost":0,"ratio":0,"rmpRatioCredit":'+Math.round(startBalance*100)+',"denom":0.0},"result":['+results+']},"route":"game.colliderResult","id":0,"type":3}';
_self.FormatAndSendMessage(dat,[response],dat.messageView);	
sys.Rollback();   	
return;	
}	
...
results='{"bid":"'+bid+'","fid":[],"success":true,"die":false,"score":0,"income":0,"chairId":0,"diefids":[],"winscore":[0],"cannonlevel":0,"fishscore":[],"pauseTime":0}';		
...
var response ='{"answerType":"game.colliderResult","Win":'+(totalWin*100)+',"Balance":'+(endBalance)+',"curBet":'+_self.gameData.Bet+',"responseView":[4,0,0,0,6,'+String('game.colliderResult').length+'],"msg":{"player":{"gender":0,"id":"accessKey|USD|'+sys.userName+'","gold":0,"delta":0,"gain":0,"cost":0,"ratio":0,"rmpRatioCredit":0.1,"denom":0.0},"result":['+results+']},"route":"game.colliderResult","id":0,"type":3}';	
