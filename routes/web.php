...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    Route::get('google-login', ['as' => 'frontend.auth.google.login', 'uses' => 'Auth\AuthController@googleLogin']);
    Route::get('google-redirect', ['as' => 'frontend.auth.google.redirect', 'uses' => 'Auth\AuthController@googleRedirect']);
    ...
    */
    ...
    Route::get('profile/metamask', ['as' => 'frontend.profile.metamask', 'uses' => 'ProfileController@metamask']);
...
Route::prefix('backend')
    ->middleware(['auth', 'checker'])->group(function () {
        Route::namespace('Backend')->group(function () {
            ...
            Route::put('/withdraw/{withdraw}/{status}', ['as' => 'backend.withdraw.confirm', 'uses' => 'DashboardController@confirmWithdraw', 'middleware' => 'only_for_admin']);
        ...
        */
			...
			Route::delete('user/delete', ['as' => 'backend.users.delete','uses' => 'UsersController@deleteUsers','middleware' => 'permission:users.delete']);
